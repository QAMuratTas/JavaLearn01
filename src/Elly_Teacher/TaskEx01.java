...
public class TaskEx01 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.print("Birinci sayinizi girer misiniz? ");first = scan.nextInt();
        System.out.print("Ikinci sayinizi girer misiniz? ");second = scan.nextInt();
        System.out.print("Ucuncu sayinizi girer misiniz? ");third = scan.nextInt();
        System.out.print("Dorduncu sayinizi girer misiniz? ");fourth = scan.nextInt();
        System.out.print("Besinci sayinizi girer misiniz? ");fifth = scan.nextInt();
