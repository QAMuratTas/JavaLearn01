     ...
     public static void main(String[] args) {
         ...
         double [] miktar ={1,2,3.5,2.5,6};
          ...
          for (int i = 0; i < urun.length ; i++) {
               System.out.printf("%-10s %-5.2f kg  €%-5.2f  €%5.2f\n "
...
double toplamOdencekPara=0;
         for (int i = 0; i <miktar.length ; i++) {
             toplamOdencekPara +=miktar[i]*brfiyat[i];

         }
         System.out.printf("toplam %5.2fkg   %6.2f€",toplamUrunMiktar,toplamOdencekPara);
