package BenimJava.Projects.P1.P04_okulYonetimi.ogrcOgrtYonetimi.ogrcOgrtYonetimi02;
                ...
                if (kisi.equalsIgnoreCase("Ogrenci")) {//3
                    ...
                    try {//4
                        ...
                        if (yas < 8 || yas > 19) {//5
                            ...
                            scan.nextLine();//dummy
                            System.out.println(Arrays.toString(siniflar));//*** sınıflar listelendi
                    ...
                    try {//4
                        ...
                        if (yas < 23 ) {
                            ...
                            System.out.println("branslar = " + Arrays.toString(branslar));//**** branşlar listelendi doğru yazılması adına
                            boolean flag = true;
                            // String brans = "";
                            try {//6
