...
public class Kitapcı_KitapEkle {
	...
	public static List<EklenenKitaplar> kitapEkle() {
		...
		do {
			...
			//System.out.println("liste = " + liste);// mrt...burada neden ref değeri yazdırıyor. kısacası neden listarray olan listi neden direk yazdıramıyoruz
			System.out.println("kitapno+kitapAd+yazarAd+fiyat = " +count + kitapAd + yazarAd + fiyat);//mrt...
			count++;
