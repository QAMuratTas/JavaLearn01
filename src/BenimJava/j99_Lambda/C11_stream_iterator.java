...
public class C11_stream_iterator {
    public static void main(String[] args) {
        ...
        System.out.println("     *******     ");
        System.out.println("TASK03--> " + toplaIkSayi(10));
        System.out.println("     *******     ");
        System.out.println("Task4(10) = " + task4(10));
        System.out.println("     *******     ");
        task5(10);
        System.out.println("     *******     ");
        System.out.println("     *******     ");
...
//iterate(seed, repeat action) --> seed'den başlayarak repeat action'a göre  sonsuza kadar elemanları akısa alır.
    ...
    public static int toplaIkSayi(int x) {
        return IntStream.iterate(2, t -> t + 2).// 2 den başlayıp 2 arttırılann tekrar işlemi tanımlandı->2,4,6,8....
    ...
    public static int task4(int x) {
        return IntStream.iterate(1, t -> t + 2).// 2 den başlayıp 2 arttırılann tekrar işlemi tanımlandı->2,4,6,8....
                limit(x).// akıştaki ilk x eleman akışa alınır
                sum();
