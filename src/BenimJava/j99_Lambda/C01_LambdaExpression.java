    ...
    public static void main(String[] args) {
        /*
	 	...
	 	3) "Functional Programming" hiz, code kisaligi, code okunabilirligi
	     	ve hatasiz code yazma acilarindan cok avantajlıdır.(çoğğğ iyi)
...
printElFunctional(sayi);
        ...
        System.out.println("\n        ***********           ");
        printCiftElStructure(sayi);
        System.out.println("\n        Functional method lambda             ");
        printCiftElFunctional(sayi);


    }//main sonu
//Task : "Structured Programming" (amele kod) kullanarak list elemanlarını aynı satirda aralarında bosluk olacak sekilde print ediniz.
...
//Task : "Functional Programming" (cincix kod) kullanarak list elemanlarını aynı satirda aralarında bosluk olacak sekilde print ediniz.
public static void printElFunctional(List<Integer> sayi) {
        sayi.// aksiyona girecek list coll.
                stream().// List elemanlarını yukarıdan aşağıya akışa alır
                forEach((t)-> System.out.print(t+" "));//datanın parametresine göre akıştaki herbir elemanı işleme sokar
}
/*
    ...
    */
    ...
    public static void printElFunctional1(List<Integer> sayi) {//functional pr
        sayi.// aksiyona girecek list coll.
                stream().// List elemanlarını yukarıdan aşağıya akışa alır
                forEach((System.out::print));//Method referance -> Ssytem.out yapısından print meth. call edildi.

        //MethodKaynağı::MEthod -> meth referance
...
public static void yazdir(double a){// normal method tek aksiyonlu -> seed method (tohum)->refere edilecek method
    ...
    public static void printElFunctional2(List<Integer> sayi) {//functional pr
        sayi.// aksiyona girecek list coll.
                stream().// List elemanlarını yukarıdan aşağıya akışa alır
                forEach((C01_LambdaExpression::yazdir));//Method referance -> Ssytem.out yapısından print meth. call edildi.

        //MethodKaynağı::MEthod -> meth referance

    }

//Task : "Structured Programming" (Amele kod) kullanarak list elemanlarının çiftlerini aynı satirda aralarında bosluk olacak sekilde print ediniz.
public static void printCiftElStructure(List<Integer> sayi) {// Amele method
...
//Task : "Functional Programming" (cincix kod) kullanarak list elemanlarının çiftlerini aynı satirda aralarında bosluk olacak sekilde print ediniz.
    ...
    public static void printCiftElFunctional(List<Integer> sayi) {
        ...
        sayi.
                ...
                filter(t->t%2==0).// akıştaki list elemanları çift olma şartına göre filtrelendi
