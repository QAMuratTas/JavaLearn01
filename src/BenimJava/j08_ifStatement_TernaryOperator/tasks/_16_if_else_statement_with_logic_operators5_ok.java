...
public class _16_if_else_statement_with_logic_operators5_ok {
    ...
    double d=45;
    if (d %5==0 && d %8==0){
        System.out.println("able to divide by 5 and 8");}else if (d %10==5 && d %9==0){
            System.out.println("able to divide by 9 and divide by 10 reminder is 5");}
        }
    }
// run : able to divide by 9 and divide by 10 reminder is 5
