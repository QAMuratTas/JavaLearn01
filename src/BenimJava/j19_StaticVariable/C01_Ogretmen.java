...
static String okul;
    ...
    public C01_Ogretmen(String isim, int tecrube) {//full p'li cons.
    ...
    public static void maasHesapla() { // Static
        ...
        System.out.println("Ağama helalı hos olsun afiyetle maaşı harca :");

    }
    public void evlilikYıldönümü (){ // non-static method
        System.out.println("Ağa Bir yastıkta 40 yıl en az:");
    }
