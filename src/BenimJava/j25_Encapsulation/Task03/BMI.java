...
*/
package BenimJava.j25_Encapsulation.Task03;

public class BMI {//outer class
    private String name;
    private int age;
    private double weight;
    private double height;

    public BMI(String name, int age, double weight, double height) {// ful p li cons
        this.name = name;
        this.age = age;
        this.weight = weight;
        this.height = height;
...
BMI obj = new BMI("Murat",40,105,1.72);
