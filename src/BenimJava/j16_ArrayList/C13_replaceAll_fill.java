...
import BenimJava.j16_ArrayList.odev.Arraylist;
...
Collections.replaceAll(listSayi,1,20);//sayilist'inde 1 yerine 20 değeri atandı
       Collections.replaceAll(listSayi,24,32);
        System.out.println("listSayi = " + listSayi);//replaceAll sonrası-> [20, 32, 23, 14, 19, 60, 20, 55, 27, 20, 38]
